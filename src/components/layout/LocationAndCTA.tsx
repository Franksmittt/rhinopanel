...
const OFFICE_PHONE = "035 550 0211"; // <-- CONFIRMED
const TOWING_NUMBER = "072 311 5870"; // <-- UPDATED
const GMB_LINK = "https://share.google/UBoRn59KzPkWT48fK"; // <-- ADDED
    ...
    <section className="w-full py-20 bg-white">
      <div className="container px-4 md:px-8 mx-auto space-y-16">
        ...
        <div className="w-full p-6 sm:p-8 md:p-10 flex flex-col md:flex-row items-center justify-between rounded-2xl bg-primary text-primary-foreground shadow-2xl">
            ...
            <div className="flex items-center space-x-3 md:space-x-4 mb-6 md:mb-0 w-full md:w-auto">
                ...
                <div className="min-w-0 flex-1">
                    ...
                    <p className="text-sm sm:text-base md:text-lg opacity-90">Start your claim immediately with our digital quote engine.</p>
                 </div>
            </div>
